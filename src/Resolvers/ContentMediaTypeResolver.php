...
{
    /** @var callable[]|IContentMediaType[] */
    protected array $media;

    /** @var callable|null|IContentMediaType */
    protected $defaultMedia = null;

    /**
     * @param callable[]|IContentMediaType[] $media
     * @param callable|IContentMediaType|null $defaultMedia
     */
    ...
    /**
     * @param string $name
     * @param IContentMediaType $media
     * @return ContentMediaTypeResolver
     */
    public function register(string $name, IContentMediaType $media): self
    {
    ...
    /**
     * @param callable|IContentMediaType|null $handler
     * @return ContentMediaTypeResolver
     */
