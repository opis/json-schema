...
use Opis\JsonSchema\{Helper, IFilter};
...
class FilterResolver implements IFilterResolver
{
    /** @var IFilter[][][] */
     ...
     */
    public function register(string $type, string $name, IFilter $filter): self
    {
        list($ns, $name) = $this->parseName($name);
     ...
     * @return FilterResolver
     */
    public function registerNS(string $ns, IFilterResolver $resolver): self
    {
        $this->ns[$ns] = $resolver;
